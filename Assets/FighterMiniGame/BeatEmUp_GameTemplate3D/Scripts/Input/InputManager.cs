...
public class InputManager : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (inputType == INPUTTYPE.TOUCHSCREEN) OnTouchScreenJoystickEvent();
    ...
    public void OnTouchScreenJoystickEvent()
    {
        Vector2 joystickDir = new Vector2(floatingJoystick.Horizontal, floatingJoystick.Vertical);
