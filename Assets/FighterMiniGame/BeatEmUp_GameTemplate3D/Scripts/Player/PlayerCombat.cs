...
public class PlayerCombat : MonoBehaviour, IDamagable<DamageObject>
{
    ...
    {
        // Ensure the necessary objects are initialized before proceeding
        ...
        //on weapon hit
        if (lastAttackInput == "WeaponAttack" && targetHit && currentWeapon != null) // Check if currentWeapon is not null
        {
